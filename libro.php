...
<html lang="es">
	...
	<body>
		...
		<div class="container">
			<div class="col-md-5">
			    <div class="form-area">  
			        <form role="form" method="post" action="funcionLibros">
			        <br style="clear:both">
	                    <h3 id="tituloForm">Registro de libro</h3>
							...
							<select class="form-control" name="dewey">
								<?php
									...
									if ($result->rowCount() > 0) {
										...
										{
											echo "<tr>";
											echo "<option value='".$row['clave']."'>".$row['clasificacion']."</option>";
										}
									}
								?>
							</select>
						...
						<div class="form-group">
							<select class="form-control" name="editorial">
								<?php
									...
									$consulta = new Editorial;
									$result = $consulta->consultarEditoriales();
									if ($result->rowCount() > 0) {
										foreach($result as $row)
										{
											echo "<tr>";
